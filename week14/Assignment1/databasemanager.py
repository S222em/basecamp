...
class DatabaseManager:
    ...
    def backup_to_json(self, filename: str) -> None:
        ...
        for table in self.cur.fetchall():
            ...
            columns: list = [(column[1], column[2], column[4], column[5]) for column in self.cursor.fetchall()]
    ...
    def restore_from_json(self, filename: str) -> None:
        ...
        for table_name, table_data in backup.items():
            ...
            for row in rows:
                ...
                insert_query: str = f"INSERT INTO {table_name} ({', '.join([col[0] for col in columns])}) VALUES ({placeholders})"
